 ...
 * Originally written by: WEB IDs
 * Website: Info Blog (http://web.id-komunitas.com)
 * On 29 Maret 2015
 *
...
function hn_writeContent(){
    ...
    if(hn_tampilkan_judul){
        ...
        s += "    <a href='http://web.id-komunitas.com'>Baca Juga</a>";
        s += "  </div>";
    }
    ...
    if(hn_backlink == true | hn_backlink == undefined){
        ...
        s += "  Widget by ";
        s += "  <a href='http://web.id-komunitas.com/'>";
        s += "    WEB IDs";
        s += "  </a>";
        s += "</div>";
    }
